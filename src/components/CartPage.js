      ...
      {cartItems?.length === 0 ? (
        <div className="flex flex-col justify-center">
          ...
          <button
            ...
            className="w-[130px] m-auto mt-5 bg-transparent hover:bg-orange-500 text-orange-700 font-semibold hover:text-white py-2 px-4 border border-orange-500 hover:border-transparent rounded"
          >
            Home
          </button>
        </div>
